...
@discardableResult
public func shell(_ launchPath: String, _ arguments: [String]) async -> TerminalOutput
{
...
///    }
///}
public func shell(_ launchPath: String, _ arguments: [String]) -> AsyncStream<StreamedTerminalOutput>
{
    let task = Process()
